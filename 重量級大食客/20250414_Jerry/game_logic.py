...
class Customer:
    flavors_pool = ["Vanilla", "Chocolate", "Milk", "Mint Chocolate"]
    ...
    def generate_order(self):
        ...
        for _ in range(total_scoops):
            flavor = random.choice(Customer.flavors_pool)
...
class GameLogic:
    def __init__(self):
        ...
        # 研發口味
        self.flavors_add = ["Strawberry", "Mango", "Matcha"]
    ...
    def update(self, dt):
        ...
        while self.money - self.costs >= 30 and self.flavors_add:
            new_flavor = self.flavors_add.pop(0)
            Customer.flavors_pool.append(new_flavor)
            self.money -= 30  # 扣掉成本
